...
message ( VERBOSE "DIST_NAME: ${DIST_NAME}")
message ( VERBOSE "DIST_VERSION: ${DIST_VERSION}")
message ( VERBOSE "DIST_LICENSE: ${DIST_LICENSE}")
message ( VERBOSE "DIST_AUTHOR: ${DIST_AUTHOR}")
message ( VERBOSE "DIST_MAINTAINER: ${DIST_MAINTAINER}")
message ( VERBOSE "DIST_URL: ${DIST_URL}")
message ( VERBOSE "DIST_DESC: ${DIST_DESC}")
string ( REGEX REPLACE ".*depends[ \t]?=[ \t]?[\"']([^\"']+)[\"'].*" "\\1"
         DIST_DEPENDS ${DIST_INFO} )
if ( DIST_DEPENDS STREQUAL DIST_INFO )
  set ( DIST_DEPENDS "" )
endif ()
message ( VERBOSE "DIST_DEPENDS: ${DIST_DEPENDS}")
